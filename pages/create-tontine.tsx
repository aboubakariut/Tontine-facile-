...
export default function CreateTontine() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (formData.amount < 1000) {
        throw new Error('Le montant minimum est de 1000 FCFA')
      }
  ...
  if (authLoading) {
    return <div className="container" style={{ textAlign: 'center' }}>Chargement...</div>
  }
  ...
  return (
    <>
      ...
      <header>
        ...
        <p>Configurez votre Adachi / njangi en quelques clics</p>
      </header>
      ...
      <div className="container">
        <div className="card">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <textarea
              name="description"
              placeholder="Règles spéciales, pénalités, etc."
